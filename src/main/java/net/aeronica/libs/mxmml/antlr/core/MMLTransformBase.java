...
public abstract class MMLTransformBase extends MMLBaseListener
{
    ...
    @Override
    public void enterInst(MMLParser.InstContext ctx)
    {
        instState.init();
        partState.init();
    ...
    @Override
    public void exitInst(MMLParser.InstContext ctx)
    {
    ...
    @Override
    public void exitBand(MMLParser.BandContext ctx)
    {
    ...
    public void exitTied(MMLParser.TiedContext ctx)
    {
        ...
        List<MMLParser.AnoteContext> listAnotes = ctx.anote();
    ...
    @Override
    public void enterLen(MMLParser.LenContext ctx)
    {
        if (ctx.INT() == null)
            return;
